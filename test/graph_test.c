...
int main(int argc, char **argv)
{
    ...
    ut_testing("graph_node_connection_select with only 1 unconditional connection");
    graph_node_t *test_node = graph_node_connection_select(node1);
    ...
    test_node = graph_node_connection_select(node2);
    ...
    select = 0;
    select2 = 1;
    graph_node_t *test_node2 = graph_node_connection_select(node2);
    select2 = 0;
    graph_node_t *test_node3 = graph_node_connection_select(node2);
    ...
    test_node = graph_node_connection_select(node2);
    select2 = 3;
    test_node2 = graph_node_connection_select(node2);
