...
#define ATOMIC_INCREMENT(__i, __cnt) (void)__sync_add_and_fetch(&__i, __cnt);
#define ATOMIC_DECREMENT(__i, __cnt) (void)__sync_sub_and_fetch(&__i, __cnt);
#define ATOMIC_READ(__p) __sync_or_and_fetch(&__p, 0)
